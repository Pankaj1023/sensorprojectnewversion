...
class PredictionPipeline:
    ...
    def save_input_files(self) -> str:
        try:
            pred_file_input_dir = 'prediction_artifacts'   # eh ek floder ha  prediction_artifacts name da jsnu asi  pred_file_input_dir   var vich store kita ha .........
            os.makedirs(pred_file_input_dir , exist_ok=True)

            input_csv_file = self.request.files['file']

            pred_file_path = os.path.join(                       #  ethe puri file da path create kita ja rhe ha ....
                             pred_file_input_dir , 
    ...
    def get_predicted_dataframe(self , input_dataframe_path:pd.DataFrame):
        try:
            ...
            input_dataframe.to_csv(self.prediction_pipeline_config.prediction_file_path  , index = False)   # ethe prediction file csv format de adnr save ho rhi ah 
